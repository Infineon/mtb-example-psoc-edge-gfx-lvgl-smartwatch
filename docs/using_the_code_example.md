...
The following example clones the "[Smartwatch demo using LVGL](https://github.com/Infineon/mtb-example-psoc-edge-gfx-lvgl-smartwatch)" application with the desired name "SmartwatchdemousingLVGL" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-gfx-lvgl-smartwatch --user-app-name SmartwatchdemousingLVGL --target-dir "C:/mtb_projects"
   ```
