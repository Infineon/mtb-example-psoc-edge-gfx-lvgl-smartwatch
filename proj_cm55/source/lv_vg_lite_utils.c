/*******************************************************************************
* File Name        : lv_vg_lite_utils.c
*
* Description      : This file provides implementation LVGL's utility APIs
...
void lv_vg_lite_buffer_from_draw_buf(vg_lite_buffer_t * buffer, const lv_draw_buf_t * draw_buf)
{
    ...
    vg_lite_buffer_format_t format = lv_vg_lite_vg_fmt((lv_color_format_t)draw_buf->header.cf);
                                  ...
                                  bool no_cache, bool premultiply)
{
    ...
    if(!lv_vg_lite_is_src_cf_supported((lv_color_format_t)decoded->header.cf)) {
...
bool lv_vg_lite_buffer_check(const vg_lite_buffer_t * buffer, bool is_src)
{
    ...
    /* Stride check removed - Infineon PSOC Edge E84 VG-Lite hardware uses custom stride alignment.
     * The stride is correctly computed by lv_draw_buf_vg_lite_init_handlers() override. */
#if 0
