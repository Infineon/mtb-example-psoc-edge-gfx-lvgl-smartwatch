...
* File Name        : lv_refr.c
*
* Description      : This file handles screen invalidation, area refreshing,
*                    and rendering of graphical objects. It manages redraw
*                    requests and coordinates buffer flushing to the display
*                    display driver.
*
